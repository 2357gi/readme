...
#### プログラミングについて
プログラミング歴が浅く、今までフレームワーク等を用いた実装が多かったので**プログラミング能力**自体は低い  
**知らないものを調べてつかえるようにする**という能力は高かったため今までなんとかなってきたが、  
...
hadoop, sparkを用いて自社サービスレコメンドシステムのプロトタイプの開発を行った。
...
現在k8sに載せ替え他の研究室のプロダクトとマイクロサービス化するために勉強中。   

使用技術: Ruby(ruby on rails)/RESTapi/AWS/nginx/python(raspi)/(k8s: 試験中)
...
使用技術 :Spark/Pyspark/nodejs/mongodb/EC2/EMR/Redis/S3
